...
namespace skylance_backend.Controllers
{
    ...
    public class CancelFlightController : Controller
    {
        ...
        public IActionResult GetCancelFlight(string flightBookingDetailId)
        {
            ...
            var overbooking = _db.OverbookingDetails.FirstOrDefault(o => o.OldBookingFlightDetailId == flightBookingDetail.Id.ToString());

            var flightDuringTime = flightBookingDetail.FlightDetail.DepartureTime - DateTime.Now;
            return Ok(new
            {
